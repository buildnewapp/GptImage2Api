...
1. **Extract Image Needs:**
   ...
   - Auto-adds body images for suitable H2 sections until the target body image count is reached
...
3. **Insert Into Draft:**
   ...
   - Inserts auto-generated featured image after the H1
   - Inserts auto-generated body images after selected section intros
   - Updates alt text for SEO
   - Preserves markdown formatting

**Image Classification:**

- **Featured/Hero Images:** Photorealistic style, 16:9
  - Trigger: First image or auto-generated from title
  - Example: "Professional email marketing dashboard"

- **Section Images:** Illustration style, 4:3
  - Trigger: Images within content sections or auto-detected H2 sections
  - Example: "Email list building strategy"

- **Diagrams/Infographics:** Technical diagram style, 16:9
