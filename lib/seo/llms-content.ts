...
const llmsCopy = {
  en: {
    ...
    summary:
      "Sdance AI is an AI video generation platform focused on Seedance 2.0 online creation and API access. It helps creators generate AI videos, browse public examples, reuse prompts, review pricing, and read developer documentation for AI generation APIs.",
    ...
    descriptions: {
      ...
      home: "Official homepage for Sdance AI and Seedance 2.0 video generation.",
  ...
  ja: {
    ...
    summaryLabel: "概要",
    summary:
      "Sdance AI は Seedance 2.0 のオンライン作成と API アクセスに重点を置いた AI 動画生成プラットフォームです。クリエイターが AI 動画を生成し、公開例を確認し、プロンプトを再利用し、料金を確認し、AI 生成 API の開発者向けドキュメントを読むためのサイトです。",
    versionTitle: "日本語版",
    descriptions: {
      ...
      home: "Sdance AI と Seedance 2.0 動画生成の公式ホームページ。",
  ...
  zh: {
    ...
    summaryLabel: "摘要",
    summary:
      "Sdance AI 是面向 Seedance 2.0 在线创作与 API 接入的 AI 视频生成平台。它帮助创作者生成 AI 视频、浏览公开案例、复用提示词、查看价格，并阅读 AI 生成 API 的开发者文档。",
    versionTitle: "中文版本",
    descriptions: {
      ...
      home: "Sdance AI 与 Seedance 2.0 视频生成的官方首页。",
...
export async function buildLlmsText() {
  ...
  return [
    ...
    "## Summary",
    "",
    `${siteConfig.name} is an AI video generation platform focused on Seedance 2.0 online creation and API access. It helps users generate videos, explore prompts and showcases, review pricing, and read AI video creation resources.`,
    "",
    "## Key Pages",
    "",
    ...keyPages.map((page) =>
...
export async function buildLlmsFullText() {
  ...
  return [
    ...
    "## Site Summary",
    "",
    `${siteConfig.name} is an AI video generation platform focused on Seedance 2.0 online creation and API access. The site helps creators generate AI videos, browse public examples, reuse prompts, review pricing, and read developer documentation for AI generation APIs.`,
    "",
    ...localeSections,
    "",
    "## Languages",
