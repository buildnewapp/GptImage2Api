...
test("exposes broader KIE video families with older supported variants", () => {
  assert.deepEqual(
    ...
    [
      ...
      "fal-kling-o3-pro-text-to-video",
      "fal-kling-o3-standard-text-to-video",
      "fal-kling-o3-pro-image-to-video",
      "fal-kling-o3-standard-image-to-video",
      "fal-kling-o3-pro-reference-to-video",
      "fal-kling-o3-standard-reference-to-video",
      "fal-kling-o3-pro-video-edit",
      "fal-kling-o3-standard-video-edit",
      "kling-3.0",
  ...
  assert.deepEqual(
    ...
    [
      "wan-3.0-video",
      "wan-3.0-video-prime",
      "fal-wan-3.0-text-to-video",
      "fal-wan-3.0-image-to-video",
      "fal-wan-3.0-reference-to-video",
      "fal-wan-3.0-prime-text-to-video",
      "fal-wan-3.0-prime-image-to-video",
      "fal-wan-3.0-prime-reference-to-video",
  ...
  assert.deepEqual(
    ...
    [
      ...
      "fal-gpt-image-2.5-flare-text-to-image",
      "fal-gpt-image-2.5-flare-edit",
      "fal-gpt-image-2.5-sunburst-text-to-image",
  ...
  assert.deepEqual(
    ...
    [
      ...
      "grok-imagine-2.0-image-edit",
      "grok-imagine-2.0-segment-edit",
      "grok-imagine-2.0-segment-map",
      "fal-grok-imagine-2.0-text-to-image",
      "fal-grok-imagine-2.0-image-edit",
