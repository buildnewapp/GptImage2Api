...
export default async function AlternativesPage({ params }: { params: Params }) {
  ...
  const tagsResult = await listTagsAction({ postType: "alternative" });
    ...
    return (
      <div className="container mx-auto px-4 py-16">
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <h1 className="mb-2 text-3xl font-semibold">{t("alternativesEmptyTitle")}</h1>
          <p className="max-w-md text-muted-foreground">
            {t("alternativesEmptyDescription")}
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mx-auto mb-10 max-w-3xl text-center">
        <h1 className="text-4xl font-semibold tracking-tight">{t("alternativesTitle")}</h1>
      ...
      <PostList
        ...
        showCover={POST_CONFIGS.alternative.showCoverInList}
        emptyMessage="No alternatives found for this tag."
      />
    </div>
  );
}
