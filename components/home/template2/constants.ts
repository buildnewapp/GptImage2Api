...
export const pricingToggleIdleClass =
  "rounded-full px-8 py-3 text-sm font-semibold text-slate-500 transition-colors hover:text-slate-700 dark:text-slate-300 dark:hover:text-white";
export const pricingToggleActiveClass =
  "rounded-full bg-[linear-gradient(135deg,#1f2a44_0%,#253a64_100%)] px-8 py-3 text-sm font-semibold text-white shadow-[0_16px_28px_-20px_rgba(15,23,42,0.45)] transition-all dark:bg-[linear-gradient(135deg,#274f90_0%,#3b82f6_100%)]";
...
export const pricingStartedButtonClass =
  "inline-flex items-center justify-center whitespace-nowrap rounded-full font-semibold ring-offset-background transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-12 px-7 text-sm sm:text-base w-full bg-[linear-gradient(180deg,#dbe4f2_0%,#cfd9ea_100%)] text-slate-900 shadow-[inset_0_1px_0_rgba(255,255,255,0.85),0_14px_30px_-24px_rgba(148,163,184,0.5)] hover:brightness-[0.99] dark:bg-[linear-gradient(180deg,#313a4d_0%,#2a3345_100%)] dark:text-white dark:shadow-[0_18px_32px_-24px_rgba(2,8,23,0.72)]";
export const pricingMaxButtonClass =
  "inline-flex items-center justify-center whitespace-nowrap rounded-full font-semibold ring-offset-background transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-12 px-7 text-sm sm:text-base w-full bg-[linear-gradient(135deg,#1f2a44_0%,#253a64_100%)] text-white shadow-[0_18px_32px_-24px_rgba(15,23,42,0.55)] hover:-translate-y-0.5 hover:brightness-110 dark:bg-[linear-gradient(135deg,#223a69_0%,#274b87_100%)]";
