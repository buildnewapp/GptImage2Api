    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-3xl px-4 py-32 sm:px-6 sm:py-36">
        <div className="mb-8 text-center sm:mb-10">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/8 px-4 py-1.5 text-xs font-medium text-white/80 backdrop-blur-md">
