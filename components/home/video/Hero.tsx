    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-3xl px-4 py-32 sm:px-6 sm:py-36">
        <div className="mb-8 text-center sm:mb-10">
          <div data-aos="fade-up" className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/8 px-4 py-1.5 text-xs font-medium text-white/80 backdrop-blur-md">
            <Image src="/logo.png" alt="Logo" width={28} height={28} />
            {hero.badge}
          </div>
          <h1 data-aos="fade-up" className="text-3xl font-bold tracking-tight text-white text-balance sm:text-4xl lg:text-5xl">
            {hero.title}
            <span className="mt-1 block text-primary">{hero.highlight}</span>
          </h1>
          <p data-aos="fade-up" className="mx-auto mt-4 max-w-xl text-base text-white/60 sm:text-lg">
            {hero.description}
          </p>
        </div>
