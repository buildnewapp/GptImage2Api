...
export const AI_VIDEO_STUDIO_FAMILIES: AiVideoStudioFamily[] = ([
  ...
  },
  {
    key: "minimax-h3",
    label: "MiniMax H3",
    description: "MiniMax H3 video generation with text, image, and multimodal references",
    icon: "hailuo",
    tags: [{ text: "HOT", type: "hot" }],
    selectable: true,
    versions: [
      ...
      {
        key: "fal-minimax-h3-max-image-to-video",
      ...
      {
        key: "fal-minimax-h3-max-reference-to-video",
  ...
  },
  {
    key: "pixverse-v6",
    label: "PixVerse V6",
    description: "PixVerse V6 video generation, transition, reference, and extension workflows",
    icon: "pixverse",
    selectable: true,
    versions: [
      {
        ...
        label: "Text to Video",
        familyKey: "pixverse-v6",
        modelId: "video:pixverse-v6-text-to-video",
        isSpecial: true,
      },
      {
        ...
        label: "Image to Video",
        familyKey: "pixverse-v6",
        modelId: "video:pixverse-v6-image-to-video",
        isSpecial: true,
      },
      {
        key: "pixverse-v6-first-last-frame-transition",
        label: "First & Last Frame Transition",
        familyKey: "pixverse-v6",
        modelId: "video:pixverse-v6-first-last-frame-transition",
        isSpecial: true,
      },
      {
        key: "pixverse-v6-fusion-reference-to-video",
        label: "Fusion / Reference to Video",
        familyKey: "pixverse-v6",
        modelId: "video:pixverse-v6-fusion-reference-to-video",
        isSpecial: true,
      },
      {
        key: "pixverse-v6-video-extension",
        label: "Video Extension",
        familyKey: "pixverse-v6",
        modelId: "video:pixverse-v6-video-extension",
        isSpecial: true,
      },
    ],
  },
  ...
  },
  {
    ...
    versions: [
      ...
      },
      {
        ...
        label: "Seedream5.0 Pro - Layer Decomposition",
        familyKey: "seedream-image",
        modelId: "image:seedream-5-0-pro-layer-decomposition",
        isSpecial: true,
        isHot: true,
      },
      {
  ...
  },
  {
    ...
    description: "Qwen Image 3.0 generation and editing models",
    icon: "qwen",
    tags: [{ text: "HOT", type: "hot" }],
    selectable: true,
    versions: [
      {
        key: "qwen3-text-to-image",
        label: "Text to Image",
      ...
      },
      {
        ...
        label: "Pro Text to Image",
        familyKey: "qwen3-image",
        modelId: "image:qwen3-pro-text-to-image",
        isSpecial: true,
      },
      {
        key: "qwen3-pro-image-to-image",
        label: "Pro Image to Image",
        familyKey: "qwen3-image",
        modelId: "image:qwen3-pro-image-to-image",
        isSpecial: true,
      },
    ],
  },
