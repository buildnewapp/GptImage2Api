...
export const AI_VIDEO_STUDIO_FAMILIES: AiVideoStudioFamily[] = [
  ...
  },
  {
    ...
    versions: [
      {
        key: "veo-3.1-fast-text-to-video",
        label: "Veo 3.1 Fast Text to Video",
        familyKey: "veo-3.1",
        modelId: "video:veo-3.1-fast-text-to-video",
      },
      {
        key: "veo-3.1-fast-image-to-video",
        label: "Veo 3.1 Fast Image to Video",
        familyKey: "veo-3.1",
        modelId: "video:veo-3.1-fast-image-to-video",
      },
      {
        key: "veo-3.1-quality-text-to-video",
        label: "Veo 3.1 Quality Text to Video",
        familyKey: "veo-3.1",
        modelId: "video:veo-3.1-quality-text-to-video",
      },
      {
        key: "veo-3.1-quality-image-to-video",
        label: "Veo 3.1 Quality Image to Video",
        familyKey: "veo-3.1",
        modelId: "video:veo-3.1-quality-image-to-video",
      },
    ],
  },
  {
